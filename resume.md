...
- AI/ML: Generative AI, Agentic AI, LLM Integration, Prompt Engineering, MCP (Model Context Protocol), Microsoft Foundry, GitHub Copilot CLI/Agency, Agent Orchestration
- Business Platforms: Dynamics 365, Dataverse, Aspire (.NET), Azure Marketplace
